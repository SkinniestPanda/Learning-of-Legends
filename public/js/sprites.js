...
const soldier = new Sprite({
    ...
    sprites: {
        ...
        run: { 
            imageSrc: 'images/allies/Medieval_King_Pack_2/Run.png', 
            framesMax: 8
        },
        takeHit: {
...
const allyTop = new Sprite({
    ...
    sprites: {
        ...
        attack1: {
            imageSrc: 'images/allies/Fantasy_Warrior/Attack1.png',
            framesMax: 7
        },
        attack2: {
            imageSrc: 'images/allies/Fantasy_Warrior/Attack2.png',
            framesMax: 7
        },
        attack3: {
            imageSrc: 'images/allies/Fantasy_Warrior/Attack3.png',
            framesMax: 8
        },
        run: { 
            imageSrc: 'images/allies/Fantasy_Warrior/Run.png', 
            framesMax: 8
        },
        takeHit: {
...
const allyBottom = new Sprite({
    ...
    sprites: {
        idle: {
            imageSrc: 'images/allies/Huntress_2/Idle.png',
            framesMax: 10
        },
        attack: {
            imageSrc: 'images/allies/Huntress_2/Attack.png',
            framesMax: 6
        },
        run: { 
            imageSrc: 'images/allies/Huntress_2/Run.png', 
            framesMax: 8
        },
        takeHit: {
            imageSrc: 'images/allies/Huntress_2/Get Hit.png',
            framesMax: 3
        },
        death: {
            imageSrc: 'images/allies/Huntress_2/Death.png',
            framesMax: 10
        },
    },
});
...
const enemyTop = new Sprite({
    ...
    sprites: {
        ...
        run: { 
            imageSrc: 'images/mobs/Goblin/Run.png', 
            framesMax: 8
        },
        takeHit: {
...
const enemyBottom = new Sprite({
    ...
    sprites: {
        idle: {
            imageSrc: 'images/mobs/Skeleton/Idle.png',
            framesMax: 4
        },
        attack: {
            imageSrc: 'images/mobs/Skeleton/Attack.png',
            framesMax: 8
        },
        run: { 
            imageSrc: 'images/mobs/Skeleton/Idle.png', 
...
const orc = new Sprite({
    ...
    sprites: {
        ...
        run: { 
            imageSrc: 'images/mobs/Evil_Wizard_2/Run.png', 
            framesMax: 8
        },
        takeHit: {
